...
![Flujos de migración interestatal 2015–2020](untitled.GIF){style="max-width:100%; border-radius:8px;"}
...
[La estadística mide territorios. La dignidad se juega en personas.]{.paradoja-quote}
:::
...
::: {.cta-share}
[Compartir en X](https://twitter.com/intent/tweet?text=En+México+no+puedes+hablar+de+pobreza+sin+hablar+de+dónde+naciste.+El+análisis+de+@ASHIRA_HackODS+lo+demuestra+con+8+años+de+datos+oficiales.){.cta-share-btn .twitter target="_blank" rel="noopener"}
[Compartir en LinkedIn](https://www.linkedin.com/sharing/share-offsite/?url=https://ashira.github.io){.cta-share-btn .linkedin target="_blank" rel="noopener"}
:::
