...
ashira_tpl.layout = go.Layout(
    ...
    font=dict(color="#c9d1d9", family="Inter, -apple-system, sans-serif", size=13),
    title=dict(font=dict(family="Fraunces, Georgia, serif", color="white", size=20), x=0.5, xanchor="center"),
    ...
    hoverlabel=dict(bgcolor="#1a1a2e", font_color="white", bordercolor="#30363d", font_size=13),
...
fig.add_vline(x=nac, line_dash="dash", line_color="#f5a623", opacity=0.85,
              ...
              annotation_font_color="#0d1117", annotation_font_size=12,
...
fig.add_annotation(
    ...
    borderwidth=1,
    borderpad=24,
    font=dict(size=13, color="#c9d1d9", family="Arial"),
    align="left",
)
fig.update_layout(
    height=860,
    ...
    yaxis=dict(categoryorder="total ascending", tickfont=dict(size=12), title=""),
    title=dict(
...
fig.update_traces(marker=dict(size=14, line=dict(width=1.5, color="white")),
                  ...
                  textfont=dict(size=10, color="#e6edf3", family="Inter,sans-serif"),
                  hovertemplate=(
...
fig.update_layout(
    height=900,
    xaxis=dict(side="top", tickangle=0, tickfont=dict(size=11)),
