...
_html_globe = f"""
<div style="font-family:Inter,sans-serif;border-radius:14px;overflow:hidden;margin:8px 0 4px;background:#000;position:relative;">
  ...
  <div style="position:absolute;bottom:0;left:0;right:0;z-index:20;background:rgba(4,12,24,0.92);padding:10px 22px 12px;display:flex;gap:16px;align-items:center;flex-wrap:wrap;row-gap:8px;border-top:1px solid rgba(26,60,92,0.6);pointer-events:none;">
    <span style="color:#3d5268;font-size:0.68em;font-family:Inter,sans-serif;text-transform:uppercase;letter-spacing:0.08em;font-weight:600;">Puntos</span>
    <span style="display:flex;align-items:center;gap:7px;">
      ...
      <span style="color:#8ba4be;font-size:0.79em;font-family:Inter,sans-serif;">Receptor neto de migraci&#243;n</span>
    </span>
    <span style="display:flex;align-items:center;gap:7px;">
      ...
      <span style="color:#8ba4be;font-size:0.79em;font-family:Inter,sans-serif;">Emisor neto de migraci&#243;n</span>
    </span>
    <span style="width:1px;height:16px;background:rgba(26,60,92,0.8);display:inline-block;margin:0 2px;flex-shrink:0;"></span>
    <span style="color:#3d5268;font-size:0.68em;font-family:Inter,sans-serif;text-transform:uppercase;letter-spacing:0.08em;font-weight:600;">Arcos</span>
    <span style="display:flex;align-items:center;gap:7px;">
      ...
      <span style="color:#8ba4be;font-size:0.79em;font-family:Inter,sans-serif;">Menor volumen</span>
    </span>
    <span style="display:flex;align-items:center;gap:7px;">
      ...
      <span style="color:#8ba4be;font-size:0.79em;font-family:Inter,sans-serif;">Mayor volumen</span>
    </span>
    <span style="margin-left:auto;color:#273848;font-size:0.68em;font-family:Inter,sans-serif;">INEGI &#183; Censo 2020</span>
  </div>
</div>
...
(function(){{
  ...
  try{{
    var g=Globe()
      ...
      .polygonCapColor(function(){{return '#0c1825';}})
      .polygonSideColor(function(){{return '#081218';}})
      .polygonStrokeColor(function(){{return '#1a3a5c';}})
