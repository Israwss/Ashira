...
<div style="font-family:Inter,sans-serif;border-radius:14px;overflow:hidden;margin:8px 0 4px;background:#000;">
  ...
  <div id="globe-flujo-ashira" style="width:100%;height:660px;background:#000;"></div>
...
(function(){{
  ...
  function init(){{
    var container=document.getElementById('globe-flujo-ashira');
    if(!container||!window.Globe)return;
    var cv=document.createElement('canvas');cv.width=2;cv.height=2;
    var ctx=cv.getContext('2d');ctx.fillStyle='#040c18';ctx.fillRect(0,0,2,2);
    var maxTot=Math.max.apply(null,NODES.map(function(n){{return n.tot;}}));
    var g=Globe()
      ...
      .polygonSideColor(function(){{return '#0d1a26';}})
      .polygonStrokeColor(function(){{return '#1e3a50';}})
      ...
      .arcLabel(function(d){{
        return '<div style="background:rgba(8,14,24,0.95);padding:9px 13px;border-radius:8px;font-family:Inter,sans-serif;border:1px solid rgba(255,255,255,0.12);max-width:220px">'
      ...
      .pointLabel(function(d){{
        ...
        return '<div style="background:rgba(8,14,24,0.95);padding:9px 13px;border-radius:8px;font-family:Inter,sans-serif;border:1px solid rgba(255,255,255,0.12)">'
